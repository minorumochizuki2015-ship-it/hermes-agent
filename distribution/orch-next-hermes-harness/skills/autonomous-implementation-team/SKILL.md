---
name: autonomous-implementation-team
version: "1.0.0"
description: Use for isolated Hermes teams; not single-lane work.
...
# Autonomous Implementation Team Skill

Decompose a user-capability slice into isolated Hermes workers without creating duplicate owners.
...
2. Use one controller, disjoint worktrees and write sets, bounded `delegate_task` calls, and deterministic return consumption.
