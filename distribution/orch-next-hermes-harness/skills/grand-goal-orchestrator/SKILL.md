---
name: grand-goal-orchestrator
version: "1.0.0"
description: Use for broad Grand Goals; not single-phase tasks.
...
# Grand Goal Orchestrator Skill

Create or verify the goal envelope, capability targets, phase ladder, dependencies, acceptance surfaces, rollback, audit, and continuation rule.
...
2. Hermes selects and executes operational slices; protected policy and final completion remain Maestro-authority decisions.
