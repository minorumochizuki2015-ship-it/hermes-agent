---
name: orch-next-recovery
version: "1.0.0"
description: Use for interrupted ORCH work; not completed sessions.
...
# Orch Next Recovery Skill

Resume interrupted work from exact repo, goal, task, checklist, runtime, and owner state.
...
2. Prefer the known current owner, reconstruct the next action, and never revive a retired Maestro execution route.
