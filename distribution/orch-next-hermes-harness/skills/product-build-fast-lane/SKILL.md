---
name: product-build-fast-lane
version: "1.0.0"
description: Use for bounded low-risk builds; not protected changes.
...
# Product Build Fast Lane Skill

Admit a bounded reversible product slice and carry it through implementation and proportional validation.
...
2. Use the smallest capable lane, preserve one writer, and stop at protected integration or acceptance boundaries.
...
Review the reference scan at 8 minutes, the first implementation action at 10
minutes, and runnable or acceptance delta at 20 minutes. At 25 minutes without
any material delta, return `FULL_ROUTE_REQUIRED` for re-evaluation instead of
continuing the same stalled approach. These are review points, not elapsed-only
worker stop clocks; productive work with a real material delta continues.
