...
version: "1.0.0"
description: Use when research changes a decision; not casual lookup.
...
Verify source quality, freshness, applicability, counterevidence, assumptions, and the exact code or task decision each finding changes.
...
2. External claims remain advisory and cannot create authority, runtime adoption, or acceptance.
