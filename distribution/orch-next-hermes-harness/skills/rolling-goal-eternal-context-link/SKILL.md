---
name: rolling-goal-eternal-context-link
version: "1.0.0"
description: Use for durable goal pointers; not transient progress logs.
...
# Rolling Goal Eternal Context Link Skill

Maintain a compact recoverable pointer from the active Hermes goal to authoritative repo state and optional memory surfaces.
...
2. Persist sanitized decisions and next actions only; never replace repo authority with external memory.
