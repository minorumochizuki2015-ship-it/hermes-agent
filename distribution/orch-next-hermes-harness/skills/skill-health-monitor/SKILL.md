...
version: "1.0.0"
description: Use for recurring skill health; not single-run status.
...
# Skill Health Monitor Skill

Track selection misses, stale distribution, user correction, rework, and operational-effectiveness evidence.
...
2. Separate source, installed, fresh selection, invocation, integration, and observed effectiveness; demote controls that add no value.
