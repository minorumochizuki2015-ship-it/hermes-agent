---
name: cross-research-admission-loop
version: "1.0.0"
description: Use to admit external findings; not routine browsing.
...
# Cross Research Admission Loop Skill

Evaluate advisory inputs for relevance, evidence quality, contradiction, implementation mapping, and stop conditions.
...
2. Translate admitted findings into existing tasks, fixtures, and patches; research cannot grant protected authority or acceptance.
