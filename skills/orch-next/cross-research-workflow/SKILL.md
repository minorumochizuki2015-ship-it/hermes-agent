---
name: cross-research-workflow
version: "1.0.0"
description: Use for bounded comparative research; not quick lookups.
...
# Cross Research Workflow Skill

Plan bounded research, collect attributable evidence, compare counterevidence, and produce implementation-ready findings.
...
2. Use `web_search` and `web_extract` when available; keep external advice non-authoritative until consumed into source behavior.
