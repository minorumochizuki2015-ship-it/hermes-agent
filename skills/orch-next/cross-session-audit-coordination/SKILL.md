---
name: cross-session-audit-coordination
version: "1.0.0"
description: Use for cross-session audit return; not local self-review.
...
# Cross Session Audit Coordination Skill

Coordinate a writer and independent audit role with fixed revision, exact handoff, findings intake, repair, and re-audit.
...
2. Recover ended roles through Hermes session continuation; no Maestro execution or user-relayed packet is permitted.
