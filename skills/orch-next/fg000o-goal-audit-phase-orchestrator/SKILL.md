---
name: fg000o-goal-audit-phase-orchestrator
version: "1.0.0"
description: Use for FG000O phase continuity; not unrelated chat work.
...
# Fg000o Goal Audit Phase Orchestrator Skill

Maintain the requirement-definition goal, natural provider-backed dialogue, tasks, checklist, implementation, and independent review across phases.
...
2. Hermes owns session and worker continuity; Maestro supplies only validator and claim-authority results.
