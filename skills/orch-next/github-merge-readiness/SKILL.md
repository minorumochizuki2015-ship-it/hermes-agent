---
name: github-merge-readiness
version: "1.0.0"
description: Use before protected Git integration; not local commits.
...
# Github Merge Readiness Skill

Inspect branch divergence, dirty state, tests, review findings, risk, rollback, and claim boundaries before requesting integration.
...
2. Hermes may prepare and validate locally; merge, protected push, release, and acceptance require the typed Maestro authority result.
