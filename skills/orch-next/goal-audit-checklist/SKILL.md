---
name: goal-audit-checklist
version: "1.0.0"
description: Use for nontrivial goal closeout; not ordinary progress.
...
# Goal Audit Checklist Skill

Verify goal scope, user-capability delta, task/checklist traceability, validation, rollback, audit, blockers, and next action.
...
2. A missing check blocks only the unsupported claim unless the typed authority result identifies a protected transition.
