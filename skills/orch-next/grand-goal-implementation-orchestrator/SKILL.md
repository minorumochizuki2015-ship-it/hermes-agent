---
name: grand-goal-implementation-orchestrator
version: "1.0.0"
description: Use for multi-phase goal delivery; not one small patch.
...
# Grand Goal Implementation Orchestrator Skill

Keep a multi-phase program bound to its final user capability while selecting and continuing the next authorized slice.
...
2. Maintain one controller, phase continuity, task/checklist traceability, validation, rollback, audit, and exact non-claims.
