---
name: grand-goal-native-goal-formulation
version: "1.0.0"
description: Use for capability-sized goals; not single-task prompts.
...
# Grand Goal Native Goal Formulation Skill

Convert a Grand Goal into a native objective that spans the next coherent user outcome, not one support task.
...
2. State phase span, continuation rule, external stop boundary, insufficient single-task condition, and non-claims.
