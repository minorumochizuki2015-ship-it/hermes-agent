...
version: "1.0.0"
description: Use for material operational failures; not minor errors.
...
Record the observable failure, impact, containment, exact cause evidence, bounded correction, regression check, and next action.
...
2. Continue disjoint safe work; do not turn one incident into a permanent broad gate or expose raw private payloads.
