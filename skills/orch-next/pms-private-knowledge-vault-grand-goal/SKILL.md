---
name: pms-private-knowledge-vault-grand-goal
version: "1.0.0"
description: Use for private-vault programs; not ordinary file tasks.
...
# Pms Private Knowledge Vault Grand Goal Skill

Coordinate the private-vault Grand Goal across canonical storage, retrieval, privacy, recovery, and user operation.
...
2. Keep raw private payloads and credentials out of telemetry and treat projection surfaces as non-authoritative.
