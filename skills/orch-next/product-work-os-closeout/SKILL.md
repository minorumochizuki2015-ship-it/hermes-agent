---
name: product-work-os-closeout
version: "1.0.0"
description: Use for evidence-layer closeout; not ongoing builds.
...
# Product Work Os Closeout Skill

Reconcile implemented behavior, normal-user operation, validation, runtime evidence, rollback, remaining work, and next owner.
...
2. Hermes prepares the closeout; typed Maestro claim authority decides which readiness words are admissible.
