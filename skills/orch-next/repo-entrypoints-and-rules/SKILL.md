---
name: repo-entrypoints-and-rules
version: "1.0.0"
description: Use before unfamiliar repo writes; not known read-only work.
...
# Repo Entrypoints And Rules Skill

Discover the exact repository instructions, build/test commands, ownership boundaries, and active authority artifacts.
...
2. Prefer current source truth over historical workpacks and bind every write to the admitted worktree and scope.
