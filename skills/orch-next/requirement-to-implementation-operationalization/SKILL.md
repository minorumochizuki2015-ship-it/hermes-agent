---
name: requirement-to-implementation-operationalization
version: "1.0.0"
description: Use for requirement-to-code trace; not planning alone.
...
# Requirement To Implementation Operationalization Skill

Trace each requirement to user capability, source scope, task, acceptance check, negative fixture, implementation delta, and remaining gap.
...
2. Continue through the authorized implementation slice; do not stop at a requirement packet or validator.
