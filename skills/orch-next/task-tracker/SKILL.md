...
name: task-tracker
version: "1.0.0"
description: Use for multi-phase task state; not trivial edits.
...
Maintain requirements, plan, checklist, task register, dependencies, owners, acceptance checks, and next actions.
...
2. Update only material transitions and keep task completion below runtime, user acceptance, and final completion.
