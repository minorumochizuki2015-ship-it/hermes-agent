---
name: ui-design-direction-approval-pipeline
version: "1.0.0"
description: Use for nontrivial UI direction; not minor CSS fixes.
...
# Ui Design Direction Approval Pipeline Skill

Establish product identity, real-data boundary, route, states, comparable directions, asset need, scoped implementation, and post-build review.
...
2. Hermes coordinates candidates and implementation; user selection and typed Maestro protected-transition results remain external acceptance boundaries.
