---
name: workflow-plan-test-patch
version: "1.0.0"
description: Use for bounded code patches; not planning-only requests.
...
# Workflow Plan Test Patch Skill

Inspect current source, define the smallest safe change, patch it, run repository-prescribed tests, and review the diff.
...
2. Continue while authorized work remains; report exact failures and do not promote local PASS into adoption.
